    ...
    QWidget(parent)
{
    ...
    vBoxLayout->addWidget(this->m_siteWidget);
    ...
    vBoxLayout->addWidget(this->m_ruptureWidget);
    ...
    vBoxLayout->addWidget(this->m_intensityMeasureWidget);
    ...
    vBoxLayout->addWidget(this->m_selectionWidget);
